(function(){
   ...
   */
   // Inserciones insertBefore (Creando lista de post populares)
   /*
   var sidebar = document.querySelector('aside');
...
/*
logo.hasAttribute("class"); indica si en logo hay un atributo , en este caso clase
logo.getAttribute("class"); indica el nonbre del atributo, en este caso clase
logo.setAttribute("class","nueva_clase"); remplaza el atributo, en este caso, la clase
*/
